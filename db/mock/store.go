...
import (
	...
	sqlc "github.com/simplebank/db/sqlc"
...
func (m *MockStore) GetDeletedAccount(ctx context.Context, id int64) (sqlc.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeletedAccount", ctx, id)
	ret0, _ := ret[0].(sqlc.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetDeletedAccount(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDeletedAccount", reflect.TypeOf((*MockStore)(nil).GetDeletedAccount), ctx, id)
}

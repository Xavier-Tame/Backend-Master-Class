...
grpc-cli:
	grpc-client-cli -service pb.SimpleBank localhost:9090

.PHONY: postgres createdb dropdb migrateup migratedown migrateup1 migratedown1  db_docs db_schema sqlc server mock proto grpc-cli
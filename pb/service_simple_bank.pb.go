...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x15rpc_update_user.proto\x1a\x14rpc_login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xf9\x03\n" +
	"\n" +
	"SimpleBank\x12\x9d\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"`\x92AC\x12\x11Create a new user\x1a.This endpoint allows you to create a new user.\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\x95\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"X\x92A;\x12\rUpdate a user\x1a*This endpoint allows you to update a user.\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\xb2\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"x\x92A\\\x12\fLogin a user\x1aLThis endpoint allows you to login a user & get access token & refresh token.\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userBy\x92A\\\x12Z\n" +
	"\x0fSimple Bank API\"B\n" +
	"\vXavier Tame\x12\x1ehttps://github.com/Xavier-Tame\x1a\x13xavs.tame@gmail.com2\x031.2Z\x18github.com/simplebank/pbb\x06proto3"
